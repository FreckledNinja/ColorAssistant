package com.example.danie.colorassistant2;
...
public class MainActivity extends AppCompatActivity {
    ...
    TextView closestColorTextView;
    TextView closestColorHexText;
    View closestColorView;
    View colorView;
    String colour;
    String colorName;
    String closestColorHex;

    //Function for finding closest color name
    ...
    public String getColorNameFromRgb(int r, int g, int b) {
        ...
        if (closestMatch != null) {
            closestColorHex="#"+ Integer.toHexString(closestMatch.getR())+ Integer.toHexString(closestMatch.getG())+Integer.toHexString(closestMatch.getB());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        closestColorTextView= (TextView) findViewById(R.id.closestColorTextView);
        closestColorHexText= (TextView) findViewById(R.id.closestColorHexText);
        colorView= (View) findViewById(R.id.colorView);
        closestColorView= (View) findViewById(R.id.closestColorView);
    ...
    public void ImageColour(Bitmap image) throws Exception {
    ...
    public String getMostCommonColour(Map map) {
        ...
        redTextView.setText("Red: "+ Integer.toHexString(rgb[0]));
        greenTextView.setText("Green: "+ Integer.toHexString(rgb[1]));
        blueTextView.setText("Blue: "+ Integer.toHexString(rgb[2]));
        colorTextView.setText("Dominant Color: #"+ Integer.toHexString(rgb[0]) + Integer.toHexString(rgb[1])  + Integer.toHexString(rgb[2]));

        //Find name of color
        colorName= getColorNameFromRgb(rgb[0], rgb[1], rgb [2]);
        closestColorTextView.setText("Closest Named Color: " + colorName);

        //Converting RGB color value to hex string
        colourTemp= "#" + Integer.toHexString(rgb[0]) + Integer.toHexString(rgb[1]) +  Integer.toHexString(rgb[2]);
